...
public class PlayerMovement : MonoBehaviour
{
    ...
    [Header("Acceleration")] private float accelRate; //The multiplier used on the final vector
    ...
    private void MovePlayer()
    {
        ...
        Vector3 singleAddVelocity =
            new Vector3(rb.velocity.x + (Time.fixedDeltaTime * velocityDifference.x * accelRate), rb.velocity.y,
                rb.velocity.z + (Time.fixedDeltaTime * velocityDifference.z * accelRate));
